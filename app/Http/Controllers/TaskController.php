	...
	public function fetchAll() {
		...
		if ($tasks->count() > 0) {
			...
			foreach ($tasks as $task) {
                ...
                <td>
                  <a href="#" id="' . $task->id . '" class="text-success mx-1 editIcon" data-toggle="modal" data-target="#editTaskModal"><i class="fa fa-pencil h4"></i></a>

                  <a href="#" id="' . $task->id . '" class="text-danger mx-1 deleteIcon"><i class="fa fa-trash h4"></i></a>
                </td>
              </tr>';
			}
			$output .= '</tbody></table>';
